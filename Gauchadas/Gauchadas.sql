...
--
-- Servidor: localhost
-- Tiempo de generación: 10-05-2017 a las 17:09:28
...
(1, 'Busco acompa?ante de viaje', 'Soy camionero y busco una persona que me acompañe en mi viaje hasta Rawson porque sufro problemas de sueño.\r\n\r\nSaldríamos el primer fin de semana de octubre y retornaríamos el fin de semana siguiente.\r\n\r\n* Condición fundamental: debe cebar buenos mates', 'La Plata', '2017-05-08', '2017-10-05', NULL);
...
CREATE TABLE `Usuario` (
  `Id_Usuario` int(11) NOT NULL,
  `nombre_usu` text NOT NULL,
  `passworld` text CHARACTER SET latin1 COLLATE latin1_spanish_ci NOT NULL,
